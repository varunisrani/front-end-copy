  ...
  return (
    <div className="flex flex-row">
      <div className="flex flex-col ">
        <div className="flex flex-row ml-5 mt-10 mad1:mt-5 mad5:ml-10">
        ...
        <div className="flex flex-col w-[55rem] mad1:w-[48rem] mad2:w-[48rem] mad5:w-[78rem] mad5:h-[37rem] mad6:w-[40rem] mad6:h-[24rem] h-[6rem] bg-nb6 rounded-lg mt-10 mad1:mt-0 mad2:mt-0 ml-5 border border-nb4 border-opacity-10 mad:mt-10">
          ...
          <span className="text-[1rem] ml-[6rem] text-nb3  mt-7 mad:ml-12 mad5:text-xl mad5:ml-[7rem] mad5:mr-2">
          ...
          <div className="flex flex-row ml-[6rem] mt-10 gap-7 mad:ml-12">
            <img
              ...
              className="h-[12rem] w-[12rem] mad:h-[9rem] mad:w-[9rem] mad1:h-[10rem] mad1:w-[10rem] mad2:h-[10rem] mad2:w-[10rem] mad5:h-[20rem] mad5:w-[20rem]"
            />
            <img
        ...
        <div className="mad:mt-5 mad1:mt-[19rem] mad2:mt-[20rem] mad3:mt-[22rem] mad5:flex mad5:flex-row mad5:justify-center mad5:items-center mad5:mt-[1rem]">
          <Input />
        </div>
      </div>
