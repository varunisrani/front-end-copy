    ...
    >
      <div className="flex">
        ...
        <div className="flex flex-col mt-6 ml-2 text-xs/3 gap-1">
          <span className="flex text-white text-[1rem] mad6:text-xs">
            Intellisys
          </span>
          <span className="flex text-sg5 mad6:text-xs">12 user</span>
        </div>
        <FaAngleDown
      ...
      <div className="flex flex-col mt-8 ml-5 gap-5  text-[1rem] mad6:text-xs">
      ...
      <div className="flex flex-col mt-8 ml-5 gap-5 text-xs/3 ">
        ...
        <div className="flex flex-row mt-5">
          ...
          <span className="text-white ml-3 text-[0.9rem] mad6:text-xs">
      ...
      <div className="flex mt-12 absolute bottom-0 mb-10">
        ...
        <CiSettings
          className="text-white mt-5 ml-[5rem] mad6:ml-4 mad:ml-14 mad1:ml-[2rem]"
          size={20}
        />
      </div>
    </motion.nav>
