  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-row ml-5 mt-10">
        ...
        />
        <span className="bg-gradient-to-r from-blue-500 via-blue-300 to-green-300 bg-clip-text text-transparent ml-[43rem] pl-40 mad1:[30rem] mad2:ml-[40rem] mad1:pl-10 text-xl mad3:ml-[40rem] mad4:ml-[48rem]">
          Log In
        </span>
      </div>
      <img
      ...
      />
      <div className="mad3:mt-10 mad4:ml-[8rem]">
        <Form2 />
      </div>
      <div className="about">
